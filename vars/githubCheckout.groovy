def resolveRepository(String repository, String author = 'Navionics', String branches = 'develop', boolean ignoreErrors, String credentialID) {
    if ( credentialID == null || credentialID.length == 0) {
        return println "[WARNING] Missing Credentials: ${credentialID}"
    } 
